class NoticesController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @notice.update(notice_params)
        format.html { redirect_to @notice, notice: "Notice was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to notices_path, notice: "Notice was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def notice_params
      params.expect(notice: [ :title, :body, :author_name, :category, :pinned ])
    end
end
